...
class Translator:
    ...
    def __init__(
        ...
        # import this
        args.user_dir = os.path.join(PWD, "custom_fairseq")
        ...
        print ('---->', utils.split_paths(self.cfg.common_eval.path))
        ...
        print ('------------->', self.max_positions, '=========', self.cfg)
    ...
    def translate(self, inputs, constraints=None):
        ...
        for id_, src_tokens, hypos, _ in sorted(results, key=lambda x: x[0]):
            ...
            #print (self.cfg.generation.nbest,'<----------', [len(hypos), self.cfg.generation.nbest])
